...
class PersonalityPredictor:
    ...
    def prepare_features(self, texts):
        ...
        additional_features = [self.preprocessor.extract_features(text) for text in texts]
        ...
        return text_features, additional_features_df
    
    def train(self, texts, personalities):
        """Train the personality prediction model"""
        # Prepare features
        text_features, additional_features = self.prepare_features(texts)
    ...
    def predict(self, text):
        ...
        # Prepare features
        text_features, _ = self.prepare_features([text])
